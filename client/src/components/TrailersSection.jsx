    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
      ...
      <div className="relative mt-6">
        ...
        <div className="mx-auto max-w-[960px] aspect-video">
          <iframe src={`https://www.youtube.com/embed/${currentTrailer.videoUrl.split("v=")[1]}`}
           title="Trailer" className="w-full h-full rounded-lg" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen
          />
        </div>
      </div>
